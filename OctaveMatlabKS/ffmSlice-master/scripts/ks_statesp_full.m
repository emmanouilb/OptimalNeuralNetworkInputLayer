...
Trpo = 33.5010341720007; %Read the period

rpo0 = LieEl(-pi/2)*rpo0; %Bring the solution onto the slice

[xsol, uu, tt] = ksETDRK4(rpo0, 2*Trpo);
...
gtw1rel = gtw1 - repmat(tw1', size(gtw1, 1), 1);
gtw1ssp = ee'*gtw1rel';
gtw1ssp = gtw1ssp';

plot3(gtw1ssp(:, 1), gtw1ssp(:, 2), gtw1ssp(:, 3), 'r', 'LineWidth', 2)

gtw2rel = gtw2 - repmat(tw1', size(gtw2, 1), 1);
gtw2ssp = ee'*gtw2rel';
gtw2ssp = gtw2ssp';

plot3(gtw2ssp(:, 1), gtw2ssp(:, 2), gtw2ssp(:, 3), 'g', 'LineWidth', 2)
