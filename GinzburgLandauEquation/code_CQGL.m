...
%eurico from https://www.uni-muenster.de/imperia/md/content/physik_tp/lectures/ss2017/numerische_Methoden_fuer_komplexe_Systeme_II/gle.pdf
% page 
gamma=1+2i; beta=-(1-1i); delta=0; chi=1;
