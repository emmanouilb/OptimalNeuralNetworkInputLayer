...
\begin{abstract}
We show empirical evidence on how to construct the optimal feature selection or architecture for the input layer of a feedfoward neural 
...
non-extended set, i.e. a multivariate set of discrete as opposed to continous time series. For forecasting spatial-temporal chaos we 
refer the reader to 
\cite{doi:10.1063/1.165894,PhysRevE.51.R2709,PhysRevLett.85.2300,Parlitz2000NonlinearPO,2000PhRvL..84.1890P,Xia2006APF,covas2016} and 
...
2018JCoPh.357..125R,2018arXiv180106637R}, although this field of research is clearly growing at the moment. Nonetheless, this area of 
...
\cite{1851RSPT..141..123S, 1852RSPT..142..103S, 1979P&SS...27.1001S,1983SoPh...89..195E,1965P&SS...13....9P,2000AdSpR..26...27W,2003A&AT...22..861B,2005GeoRL..3221106S,2005SpWea...3.8C01K,2006GMS...165..367T,2006GeoRL..3318101H, 2009SunGe...4...55C,2011SpWea...9.6001C,2013EGUGA..1510865W,2015SpWea..13..524S}.

The reasons why spatial-temporal chaos is so difficult to forecast are: first the Hausdorff dimension  of the 
attractor \cite{1985PhLA..107..101G} -- usually quite large; and second how to choose the variables to use for forecasting, i.e., is there 
...
theoretical background \cite{1981LNM...898..366T} in the Takens embedding theorem for a mathemmatical method to reconstruct the dynamics 
...
embedding method can be used to indicate what the best way is to contruct the input layer for a neural network in both space and time.

In this paper we show empirical evidence for an optimal architecture of the input layer of a neural network which tries
to forecast or predict a spatial-temporal signal. Here we show the empiral evidence for fours particular cases of
...
There has been several attemps to forecast spatial-temporal data series in the literature using neural networks ( ADD MORE REFERENCES 
...
embedding approachs to define the states vectors. In fact Parlitz and Merkwirth \cite{Parlitz2000NonlinearPO} in the
